...
from wargame_admin.views import (
    ChallengeListView,
    ...
    UserEdit,
    ResetHintsView,
    ClearSubmissionsView,
    StaffMemberAdmin,
    StaffEditView,
    StaffCreateView,
    StaffDeleteView,
    challenge_export_view,
    ChallengeFileChunkedUploadView,
    ChallengeFileChunkedUploadCompleteView,
    StaticEditorList,
    StaticEditor,
    ImportExportView,
    log_view,
...
urlpatterns = [
    ...
    path(
        "challenges/<int:challenge_id>/files/upload",
        staff_member_required(ChallengeFileChunkedUploadView.as_view()),
        name="challenge-file-upload",
    ),
    path(
        "challenges/<int:challenge_id>/files/upload_complete",
